import { realizarTransferencia, visualizarTransferencias, visualizarTransferenciaPorId, deletarTransferencia } from '../controllers/transferenciasController';
import { TransferenciaBodySchema, TransferenciaParamsSchema } from '../schemas/transferenciasSchema';
export async function transferenciasRoutes(app) {
